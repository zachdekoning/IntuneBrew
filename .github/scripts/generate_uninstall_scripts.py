...
# Import app_urls from collect_app_info.py (now in the same directory)
...
uninstall_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "Uninstall Scripts")
