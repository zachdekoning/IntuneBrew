...
Write-Host " | Version" -NoNewline; Write-Host " 0.7.0" -ForegroundColor Yellow -NoNewline
Write-Host " | Last updated: " -NoNewline; Write-Host "2025-05-09" -ForegroundColor Magenta
Write-Host ""
